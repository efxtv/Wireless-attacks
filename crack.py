...
╚███╔███╔╝██║██║     ██║      ╚██████╗██║  ██║██║  ██║╚██████╗██║  ██╗███████╗██║  ██║
 ╚══╝╚══╝ ╚═╝╚═╝     ╚═╝       ╚═════╝╚═╝  ╚═╝╚═╝  ╚═╝ ╚═════╝╚═╝  ╚═╝╚══════╝╚═╝  ╚═╝
                                                            Coded By EFX-Tv (SONU RAJ)
---------------------------------------------------------------------------------------                                                                     
(1)Start monitor mode       
(2)Stop monitor mode                        
(3)Scan Networks                            
(4)Getting Handshake(monitor mode needed)   
(5)Install Wireless Hacking tools                   
...
""")
    ...
    if var == 1 :
        ...
        def wire():
            cmd = os.system("clear")
            print("""
01) Aircrack-ng                          17) kalibrate-rtl
02) Asleap                               18) KillerBee
03) Bluelog                              19) Kismet
04) BlueMaho                             20) mdk3
05) Bluepot                              21) mfcuk
06) BlueRanger                           22) mfoc
07) Bluesnarfer                          23) mfterm
08) Bully                                24) Multimon-NG
09) coWPAtty                             25) PixieWPS
